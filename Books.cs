...
public partial class TheWitcher : Mod
{
    ...
    private void AddWitcherSkillBook()
    {
        ...
        TableUtils.LocalizationTable("gml_GlobalScript_table_books")
            .MatchFrom("book_name_end;")
            .InsertAbove(
                new Loc("book_witcher1")
                .English("Notes on Aetheric Alchemy").Chinese("以太炼金札记"),
                new Loc("book_witcher2")
                .English("On Aetheric Signs").Chinese("以太符印论")
            )
            .MatchFrom("book_content_end;")
            .InsertAbove(
                new Loc("book_witcher1")
                .English(string.Join("##",
                    "( ... )",
            ...
            .MatchFrom("book_mid_text_end;")
            .InsertAbove(
                new Loc("book_witcher1")
                .English("\"Notes on Aetheric Alchemy\"##~gr~Allows you to learn:~/~##~lg~The Witcher's Alchemy~/~#~lg~Weapon Oil Recipes~/~#~lg~Witcher Potion Recipes~/~#~lg~Witcher Decoction Recipes~/~##Reading this book grants some ~y~Experience~/~.")
                .Chinese("《以太炼金札记》##~gr~可学习：~/~##~lg~猎魔人炼金术~/~#~lg~剑油配方~/~#~lg~魔药配方~/~#~lg~煎药配方~/~##阅读本书可获得~y~经验~/~。"),
                new Loc("book_witcher2")
                .English("\"On Aetheric Signs\"##~gr~Allows you to learn:~/~##~lg~Quen Sign~/~#~lg~Axii Sign~/~#~lg~Yrden Sign~/~#~lg~Aard Sign~/~#~lg~Igni Sign~/~##Reading this book grants some ~y~Experience~/~.")
                .Chinese("《以太符印论》##~gr~可学习：~/~##~lg~昆恩法印~/~#~lg~亚克西法印~/~#~lg~亚登法印~/~#~lg~阿尔德法印~/~#~lg~伊格尼法印~/~##阅读本书可获得~y~经验~/~。")
            )
            .MatchFrom("book_desc_end;")
            .InsertAbove(
                new Loc("book_witcher1")
                .English("Idarran’s first-person notes on oils, potions, and decoctions adapted to Aldor.")
                .Chinese("艾达兰以第一人称记录他在奥尔多对剑油、魔药与煎药的改造方法与实用配方示例。"),
                new Loc("book_witcher2")
                .English("Idarran’s comparative study of Aldor’s Aether and homeland Signs, with practical rewrites.")
                .Chinese("艾达兰对“以太”与故乡法印的对照研究，并给出可实操的改写方案与训练要点。")
            )
            .MatchFrom("book_type_end;")
            .InsertAbove(
                new Loc("book_witcher1")
                .English("Written by Idarran of Ulivo").Chinese("作者：乌里沃的艾达兰"),
                new Loc("book_witcher2")
                .English("Written by Idarran of Ulivo").Chinese("作者：乌里沃的艾达兰")
            )
            .Save();
