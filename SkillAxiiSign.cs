            ...
            new LocalizationSkill(
                ...
                description: new Dictionary<ModLanguage, string>{
                    ...
                    {ModLanguage.Chinese, string.Join("##",
                        ...
                        "催眠失败或者敌人从催眠中醒来后会陷入~w~12~/~回合的~r~“慌乱”~/~。若催眠失败，则令该技能冷却时间~lg~减半~/~，同时令敌人所有技能的冷却时间~lg~+6~/~。",
                ...
                {{
                    ...
                    {{
                        ...
                        {{
                            if (is_player())
                            {{
                                scr_skill_category_change_KD(o_skill_category, -6)
                            }}
                            else
                            {{
                                scr_skill_category_change_KD_enemy(id, 6)
                            }}
                        }}
                        with (owner)
                        {{
